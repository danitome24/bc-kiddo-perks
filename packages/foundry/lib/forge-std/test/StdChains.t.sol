...
contract StdChainsMock is Test {
  ...
  function exposed_setFallbackToDefaultRpcUrls(
    bool useDefault
  ) public {
...
contract StdChainsTest is Test {
  function test_ChainRpcInitialization() public {
    ...
    assertEq(
      getChain("optimism_sepolia").rpcUrl, "https://sepolia.optimism.io/"
    );
    assertEq(
  ...
  function test_ChainBubbleUp() public {
    ...
    stdChainsMock.exposed_setChain(
      "needs_undefined_env_var", ChainData("", 123456789, "")
    );
    vm.expectRevert(
  ...
  function test_CannotSetChain_ChainIdExists() public {
    ...
    stdChainsMock.exposed_setChain(
      "another_custom_chain", ChainData("", 123456789, "")
    );
  }
