...
import {
  MockERC721, IERC721TokenReceiver
} from "../../src/mocks/MockERC721.sol";
...
contract RevertingERC721Recipient is IERC721TokenReceiver {
  function onERC721Received(
    ...
    revert(
      string(abi.encodePacked(IERC721TokenReceiver.onERC721Received.selector))
    );
  }
}
...
contract MockERC721Test is StdCheats, Test {
  ...
  function testFailSafeTransferFromToNonERC721Recipient() public {
    ...
    token.safeTransferFrom(
      address(this), address(new NonERC721Recipient()), 1337
    );
  }
  ...
  function testFailSafeTransferFromToRevertingERC721Recipient() public {
    ...
    token.safeTransferFrom(
      address(this), address(new RevertingERC721Recipient()), 1337
    );
  }
    ...
    public
  {
    ...
    token.safeTransferFrom(
      address(this), address(new WrongReturnDataERC721Recipient()), 1337
    );
  }
  ...
  {
    token.safeMint(
      address(new WrongReturnDataERC721Recipient()), 1337, "testing 123"
    );
  }
  ...
  function testSafeTransferFromToERC721Recipient(
    uint256 id
  ) public {
    address from = address(0xABCD);
  ...
  function testSafeMintToERC721Recipient(
    uint256 id
  ) public {
    ERC721Recipient to = new ERC721Recipient();
  ...
  function testFailSafeTransferFromToNonERC721Recipient(
    uint256 id
  ) public {
    token.mint(address(this), id);
  ...
  function testFailSafeTransferFromToNonERC721RecipientWithData(
    ...
    token.safeTransferFrom(
      address(this), address(new NonERC721Recipient()), id, data
    );
  }
  ...
  function testFailSafeTransferFromToRevertingERC721Recipient(
    ...
    token.safeTransferFrom(
      address(this), address(new RevertingERC721Recipient()), id
    );
  }
  ...
  function testFailSafeTransferFromToRevertingERC721RecipientWithData(
    ...
    token.safeTransferFrom(
      address(this), address(new RevertingERC721Recipient()), id, data
    );
  }
  ...
  function testFailSafeTransferFromToERC721RecipientWithWrongReturnData(
    ...
    token.safeTransferFrom(
      address(this), address(new WrongReturnDataERC721Recipient()), id
    );
  }
  ...
  function testFailSafeMintToNonERC721Recipient(
    uint256 id
  ) public {
  ...
  function testFailSafeMintToRevertingERC721Recipient(
    uint256 id
  ) public {
  ...
  function testFailOwnerOfUnminted(
    uint256 id
  ) public view {
    token.ownerOf(id);
  }
