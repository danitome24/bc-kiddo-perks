...
contract StdAssertionsTest is Test {
  ...
  function testAssertEq_Bool_Pass(
    bool a
  ) external {
  ...
  function testAssertEq_Bytes_Pass(
    bytes calldata a
  ) external {
    t._assertEq(a, a, EXPECT_PASS);
  }
  ...
  function testAssertEq_BytesErr_Pass(
    bytes calldata a
  ) external {
    t._assertEq(a, a, CUSTOM_ERROR, EXPECT_PASS);
  }
  ...
  function testAssertEq_UintArr_FailEl(
    uint256 e1
  ) public {
    vm.assume(e1 != 0);
    uint256[] memory a = new uint256[](3);
  ...
  function testAssertEq_IntArr_FailEl(
    int256 e1
  ) public {
    vm.assume(e1 != 0);
    int256[] memory a = new int256[](3);
  ...
  function testAssertEq_AddressArr_FailEl(
    address e1
  ) public {
  ...
  function testAssertEq_UintArrErr_FailEl(
    uint256 e1
  ) public {
    vm.assume(e1 != 0);
    uint256[] memory a = new uint256[](3);
  ...
  function testAssertEq_IntArrErr_FailEl(
    int256 e1
  ) public {
    vm.assume(e1 != 0);
    int256[] memory a = new int256[](3);
  ...
  function testAssertEq_AddressArrErr_FailEl(
    address e1
  ) public {
    vm.assume(e1 != address(0));
    address[] memory a = new address[](3);
