...
abstract contract ERC4626Prop is Test {
  ...
  function prop_deposit(
    ...
    assertApproxEqAbs(
      newReceiverShare, oldReceiverShare + shares, _delta_, "share"
    );
    if (oldAllowance != type(uint256).max) {
      assertApproxEqAbs(
        newAllowance, oldAllowance - assets, _delta_, "allowance"
      );
    }
  }
  ...
  function prop_withdraw(
    ...
    assertApproxEqAbs(
      newReceiverAsset, oldReceiverAsset + assets, _delta_, "asset"
    ...
    if (caller != owner && oldAllowance != type(uint256).max) {
      assertApproxEqAbs(
        newAllowance, oldAllowance - shares, _delta_, "allowance"
      );
    }
  ...
  function vault_convertToShares(
    ...
    return _call_vault(
      abi.encodeWithSelector(IERC4626.convertToShares.selector, assets)
    );
  }
  ...
  function vault_convertToAssets(
    ...
    return _call_vault(
      abi.encodeWithSelector(IERC4626.convertToAssets.selector, shares)
    );
  }
  ...
  function vault_maxMint(
    ...
    return
      _call_vault(abi.encodeWithSelector(IERC4626.maxMint.selector, receiver));
  }
  ...
  function vault_maxWithdraw(
    ...
    return
      _call_vault(abi.encodeWithSelector(IERC4626.maxWithdraw.selector, owner));
  }
  ...
  function vault_maxRedeem(
    ...
    return
      _call_vault(abi.encodeWithSelector(IERC4626.maxRedeem.selector, owner));
  }
  ...
  function vault_previewMint(
    ...
    return
      _call_vault(abi.encodeWithSelector(IERC4626.previewMint.selector, shares));
  }
  ...
  function vault_previewWithdraw(
    ...
    return _call_vault(
      abi.encodeWithSelector(IERC4626.previewWithdraw.selector, assets)
    );
  }
  ...
  function vault_withdraw(
    ...
    return _call_vault(
      abi.encodeWithSelector(
        IERC4626.withdraw.selector, assets, receiver, owner
      )
    );
  }
