...
import { ERC4626Mock } from
  "@openzeppelin/contracts/mocks/token/ERC4626Mock.sol";
import { ERC4626OffsetMock } from
  "@openzeppelin/contracts/mocks/token/ERC4626OffsetMock.sol";
...
contract ERC4626StdTest is ERC4626Test {
   ...
   */
  function testFuzzDecimalsOverflow(
    uint8 offset
  ) public {
    ...
    ERC4626VaultOffsetMock erc4626VaultOffsetMock =
      new ERC4626VaultOffsetMock(_underlying, offset);
    vm.expectRevert();
