...
interface IAccessManager {
  ...
  event RoleGrantDelayChanged(
    uint64 indexed roleId, uint32 delay, uint48 since
  );
  ...
  event TargetFunctionRoleUpdated(
    address indexed target, bytes4 selector, uint64 indexed roleId
  );
  ...
  event TargetAdminDelayUpdated(
    address indexed target, uint32 delay, uint48 since
  );
  ...
  error AccessManagerUnauthorizedCall(
    address caller, address target, bytes4 selector
  );
  error AccessManagerUnauthorizedConsume(address target);
  error AccessManagerUnauthorizedCancel(
    address msgsender, address caller, address target, bytes4 selector
  );
