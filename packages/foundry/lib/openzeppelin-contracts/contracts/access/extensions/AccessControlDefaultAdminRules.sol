  ...
  AccessControl
{
  ...
  function renounceRole(
    ...
    if (role == DEFAULT_ADMIN_ROLE && account == defaultAdmin()) {
      ...
      if (
        newDefaultAdmin != address(0) || !_isScheduleSet(schedule)
  ...
  function _beginDefaultAdminTransfer(
    ...
    uint48 newSchedule =
      SafeCast.toUint48(block.timestamp) + defaultAdminDelay();
  ...
  function _changeDefaultAdminDelay(
    ...
    uint48 newSchedule =
      SafeCast.toUint48(block.timestamp) + _delayChangeWait(newDelay);
